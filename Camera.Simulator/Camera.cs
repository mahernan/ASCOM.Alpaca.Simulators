...
namespace ASCOM.Simulators
{
    ...
    public class Camera : ICameraV4, IAlpacaDevice, ISimulation
    {
        ...
        public Camera(int deviceNumber, ILogger logger, IProfile profile)
        {
            ...
            {
                logger.LogError($"Camera {deviceNumber} - {ex.Message}");
            }
        ...
        ///
        /// symbolic Constants
        /// The (symbolic) values for GuideDirection are:
        ...
        public short BayerOffsetX
        {
            get
            {
                ...
                CheckCapabilityEnabled("BayerOffsetX", sensorType != SensorType.Monochrome);
        ...
        public short BayerOffsetY
        {
            get
            {
                ...
                CheckCapabilityEnabled("BayerOffsetY", sensorType != SensorType.Monochrome);
...
#region ICameraV4 members
        ...
        internal void ReadFromProfile()
        {
            ...
            coolerMode = Profile.GetValue(STR_CoolerMode, COOLER_COOLERMODE_DEFAULT.ToString(CultureInfo.InvariantCulture));
            coolerTimeToSetPoint = Convert.ToDouble(Profile.GetValue(STR_CoolerTimeToSetPoint, COOLER_TIME_TO_SETPOINT_DEFAULT.ToString(CultureInfo.InvariantCulture)), CultureInfo.InvariantCulture);
            coolerResetToAmbient = Convert.ToBoolean(Profile.GetValue(STR_CoolerResetToAmbient, COOLER_RESET_TO_AMBIENT_DEFAULT.ToString(CultureInfo.InvariantCulture)), CultureInfo.InvariantCulture);
            coolerFluctuation = Convert.ToDouble(Profile.GetValue(STR_CoolerFluctuations, COOLER_FLUCTUATIONS_DEFAULT.ToString(CultureInfo.InvariantCulture)), CultureInfo.InvariantCulture);
            coolerOvershoot = Convert.ToDouble(Profile.GetValue(STR_CoolerOvershoot, COOLER_OVERSHOOT_DEFAULT.ToString(CultureInfo.InvariantCulture)), CultureInfo.InvariantCulture);
            coolerPowerUpState = Convert.ToBoolean(Profile.GetValue(STR_CoolerPowerUpState, COOLER_POWER_UP_STATE_DEFAULT.ToString(CultureInfo.InvariantCulture)), CultureInfo.InvariantCulture);
            coolerUnderDampedCycles = Convert.ToDouble(Profile.GetValue(STR_CoolerUnderDampedCycles, COOLER_UNDERDAMPED_CYCLES_DEFAULT.ToString(CultureInfo.InvariantCulture)), CultureInfo.InvariantCulture);
            coolerSetPointMinimum = Convert.ToDouble(Profile.GetValue(STR_CoolerSetPointMinimum, COOLER_SETPOINT_MINIMUM_DEFAULT.ToString(CultureInfo.InvariantCulture)), CultureInfo.InvariantCulture);
            coolerGraphRange = Convert.ToBoolean(Profile.GetValue(STR_CoolerGraphRange, COOLER_GRAPH_RANGE_DEFAULT.ToString(CultureInfo.InvariantCulture)), CultureInfo.InvariantCulture);

            // read properties from profile
            interfaceVersion = Convert.ToInt16(Profile.GetValue(STR_InterfaceVersion, "3"), CultureInfo.InvariantCulture);
            pixelSizeX = Convert.ToDouble(Profile.GetValue(STR_PixelSizeX, "5.6"), CultureInfo.InvariantCulture);
            pixelSizeY = Convert.ToDouble(Profile.GetValue(STR_PixelSizeY, "5.6"), CultureInfo.InvariantCulture);
            fullWellCapacity = Convert.ToDouble(Profile.GetValue(STR_FullWellCapacity, "30000"), CultureInfo.InvariantCulture);
            maxADU = Convert.ToInt32(Profile.GetValue(STR_MaxADU, "65535"), CultureInfo.InvariantCulture);
            electronsPerADU = Convert.ToDouble(Profile.GetValue(STR_ElectronsPerADU, "0.8"), CultureInfo.InvariantCulture);

            cameraXSize = Convert.ToInt32(Profile.GetValue(STR_CameraXSize, "800"), CultureInfo.InvariantCulture);
            cameraYSize = Convert.ToInt32(Profile.GetValue(STR_CameraYSize, "600"), CultureInfo.InvariantCulture);
            ...
            bayerOffsetX = Convert.ToInt16(Profile.GetValue(STR_BayerOffsetX, "0"), CultureInfo.InvariantCulture);
            bayerOffsetY = Convert.ToInt16(Profile.GetValue(STR_BayerOffsetY, "0"), CultureInfo.InvariantCulture);

            hasCooler = Convert.ToBoolean(Profile.GetValue(STR_HasCooler, "true"), CultureInfo.InvariantCulture);
            canSetCcdTemperature = Convert.ToBoolean(Profile.GetValue(STR_CanSetCCDTemperature, "false"), CultureInfo.InvariantCulture);
            canGetCoolerPower = Convert.ToBoolean(Profile.GetValue(STR_CanGetCoolerPower, "false"), CultureInfo.InvariantCulture);
            setCcdTemperature = Convert.ToDouble(Profile.GetValue(STR_SetCCDTemperature, "-10"), CultureInfo.InvariantCulture);

            canAbortExposure = Convert.ToBoolean(Profile.GetValue(STR_CanAbortExposure, "true"), CultureInfo.InvariantCulture);
            canStopExposure = Convert.ToBoolean(Profile.GetValue(STR_CanStopExposure, "true"), CultureInfo.InvariantCulture);
            exposureMax = Convert.ToDouble(Profile.GetValue(STR_MaxExposure, "3600"), CultureInfo.InvariantCulture);
            ...
            gainMode = (GainMode)Convert.ToInt32(Profile.GetValue(STR_GainMode, "0"), CultureInfo.InvariantCulture);
            gain = Convert.ToInt16(Profile.GetValue(STR_Gain, "0"), CultureInfo.InvariantCulture);
            gainMin = Convert.ToInt16(Profile.GetValue(STR_GainMin, "0"), CultureInfo.InvariantCulture);
            gainMax = Convert.ToInt16(Profile.GetValue(STR_GainMax, "0"), CultureInfo.InvariantCulture);

            string[] gainsStringArray = Profile.GetValue(STR_Gains, "ISO 100,ISO 200,ISO 400,ISO 800,ISO 1600").Split(',');
            ...
            offsetMode = (OffsetMode)Convert.ToInt32(Profile.GetValue(STR_OffsetMode, "0"), CultureInfo.InvariantCulture);
            offset = Convert.ToInt32(Profile.GetValue(STR_Offset, "0"), CultureInfo.InvariantCulture);
            offsetMin = Convert.ToInt32(Profile.GetValue(STR_OffsetMin, "0"), CultureInfo.InvariantCulture);
            offsetMax = Convert.ToInt32(Profile.GetValue(STR_OffsetMax, "0"), CultureInfo.InvariantCulture);

            // Get sub exposure configuration
            hasSubExposure = Convert.ToBoolean(Profile.GetValue(STR_HasSubExposure, "false"), CultureInfo.InvariantCulture);
            subExposureInterval = Convert.ToDouble(Profile.GetValue(STR_SubExposureInterval, "1.5"), CultureInfo.InvariantCulture);

            string[] offsetStringArray = Profile.GetValue(STR_Offsets, "Offset for ISO 100,Offset for ISO 200,Offset for ISO 400,Offset for ISO 800,Offset for ISO 1600").Split(',');
            ...
            canFastReadout = Convert.ToBoolean(Profile.GetValue(STR_CanFastReadout, "false"), CultureInfo.InvariantCulture);

            string gainsString = Profile.GetValue("ReadoutModes", string.Empty);
        ...
        internal void SaveCoolerToProfile()
        {
            ...
            Profile.WriteValue(STR_CoolerMode, coolerMode.ToString(CultureInfo.InvariantCulture));
            Profile.WriteValue(STR_CoolerTimeToSetPoint, coolerTimeToSetPoint.ToString(CultureInfo.InvariantCulture));
            Profile.WriteValue(STR_CoolerResetToAmbient, coolerResetToAmbient.ToString(CultureInfo.InvariantCulture));
            Profile.WriteValue(STR_CoolerFluctuations, coolerFluctuation.ToString(CultureInfo.InvariantCulture));
            Profile.WriteValue(STR_CoolerOvershoot, coolerOvershoot.ToString(CultureInfo.InvariantCulture));
            Profile.WriteValue(STR_SetCCDTemperature, setCcdTemperature.ToString(CultureInfo.InvariantCulture));
            Profile.WriteValue(STR_CoolerPowerUpState, coolerPowerUpState.ToString(CultureInfo.InvariantCulture));
        ...
        internal void SaveToProfile()
        {
            ...
            Profile.WriteValue(STR_PixelSizeY, pixelSizeY.ToString(CultureInfo.InvariantCulture));
            Profile.WriteValue(STR_FullWellCapacity, fullWellCapacity.ToString(CultureInfo.InvariantCulture));
            Profile.WriteValue(STR_MaxADU, maxADU.ToString(CultureInfo.InvariantCulture));
            Profile.WriteValue(STR_ElectronsPerADU, electronsPerADU.ToString(CultureInfo.InvariantCulture));

            Profile.WriteValue(STR_CameraXSize, cameraXSize.ToString(CultureInfo.InvariantCulture));
            Profile.WriteValue(STR_CameraYSize, cameraYSize.ToString(CultureInfo.InvariantCulture));
            Profile.WriteValue(STR_CanAsymmetricBin, canAsymmetricBin.ToString(CultureInfo.InvariantCulture));
            Profile.WriteValue(STR_MaxBinX, maxBinX.ToString(CultureInfo.InvariantCulture));
            Profile.WriteValue(STR_MaxBinY, maxBinY.ToString(CultureInfo.InvariantCulture));
            Profile.WriteValue(STR_HasShutter, hasShutter.ToString(CultureInfo.InvariantCulture));
            Profile.WriteValue(STR_SensorName, sensorName.ToString(CultureInfo.InvariantCulture));
            Profile.WriteValue(STR_SensorType, ((int)sensorType).ToString(CultureInfo.InvariantCulture));
            Profile.WriteValue(STR_BayerOffsetX, bayerOffsetX.ToString(CultureInfo.InvariantCulture));
            Profile.WriteValue(STR_BayerOffsetY, bayerOffsetY.ToString(CultureInfo.InvariantCulture));
            Profile.WriteValue(STR_OmitOddBins, omitOddBins.ToString(CultureInfo.InvariantCulture));

            Profile.WriteValue(STR_HasCooler, hasCooler.ToString(CultureInfo.InvariantCulture));
            Profile.WriteValue(STR_CanSetCCDTemperature, canSetCcdTemperature.ToString(CultureInfo.InvariantCulture));
            Profile.WriteValue(STR_CanGetCoolerPower, canGetCoolerPower.ToString(CultureInfo.InvariantCulture));

            Profile.WriteValue(STR_CanAbortExposure, canAbortExposure.ToString(CultureInfo.InvariantCulture));
            Profile.WriteValue(STR_CanStopExposure, canStopExposure.ToString(CultureInfo.InvariantCulture));
            ...
            Profile.WriteValue(STR_GainMode, ((int)gainMode).ToString(CultureInfo.InvariantCulture));
            Profile.WriteValue(STR_Gain, Convert.ToString(gain, CultureInfo.InvariantCulture));
            Profile.WriteValue(STR_GainMin, Convert.ToString(gainMin, CultureInfo.InvariantCulture));
            Profile.WriteValue(STR_GainMax, Convert.ToString(gainMax, CultureInfo.InvariantCulture));
            ...
            Profile.WriteValue(STR_Gains, gainStringBuilder.ToString());

            // Write offset variables
            Profile.WriteValue(STR_OffsetMode, ((int)offsetMode).ToString(CultureInfo.InvariantCulture));
            Profile.WriteValue(STR_Offset, Convert.ToString(offset, CultureInfo.InvariantCulture));
            Profile.WriteValue(STR_OffsetMin, Convert.ToString(offsetMin, CultureInfo.InvariantCulture));
            Profile.WriteValue(STR_OffsetMax, Convert.ToString(offsetMax, CultureInfo.InvariantCulture));

            // Write sub exposure values
            Profile.WriteValue(STR_HasSubExposure, hasSubExposure.ToString(CultureInfo.InvariantCulture));
            Profile.WriteValue(STR_SubExposureInterval, subExposureInterval.ToString(CultureInfo.InvariantCulture));
            ...
            Profile.WriteValue(STR_Offsets, offsetStringBuilder.ToString());

            Profile.WriteValue(STR_CanFastReadout, canFastReadout.ToString(CultureInfo.InvariantCulture));

            if (readoutModes == null || readoutModes.Count <= 1)
            {
                Profile.DeleteValue("ReadoutModes");
            }
            else
            {
                ...
                Profile.WriteValue("ReadoutModes", gainStringBuilder.ToString());
            }
